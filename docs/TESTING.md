...
planning/calculators/formatting, mock auth, transactional repository and deterministic RTL onboarding render smoke.
The widget smoke uses bounded pumps; it must not use unbounded pumpAndSettle while the app controller owns a periodic ticker.
